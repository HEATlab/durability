...
# This plotting program must be placed in and run in the directory of the data
# files created from DataParser

set term wxt enhanced dashed "arial,16"
set datafile separator ","

set title "Interagent Constraint Density vs Performance"
set key below
set xrange [0.1:0.9]
set yrange [0:70]
set xlabel 'Interagent Constraint Density'
